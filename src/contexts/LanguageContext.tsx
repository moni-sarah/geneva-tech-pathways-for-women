...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "partner.form.terms": "I agree to be contacted by FE Hub Geneva regarding this partnership inquiry.",
    ...
    "apply.form.terms": "I confirm that I meet the eligibility criteria and agree to be contacted by FE Hub Geneva.",
  ...
  fr: {
    ...
    "partner.form.terms": "J'accepte d'être contacté(e) par FE Hub Geneva concernant cette demande de partenariat.",
