...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "about.description": "Ellatech is a career-transition and digital upskilling initiative designed to support migrant, refugee, and newcomer women in Geneva who aim to enter Switzerland's growing tech sector.",
