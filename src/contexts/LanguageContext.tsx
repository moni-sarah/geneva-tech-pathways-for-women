...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "about.description": "Ella Association is a career-transition and digital upskilling initiative designed to support women in Geneva who aim to enter Switzerland's growing tech sector — practicing and developing concrete skills so they can become independent in the digital world.",
    ...
    "partners.subtitle": "Ella Association is made possible through partnerships with local organizations, tech companies, and training institutions committed to inclusion and diversity.",
    ...
    "partner.form.terms": "I agree to be contacted by Ella Association regarding this partnership inquiry.",
    ...
    "apply.form.terms": "I confirm that I meet the eligibility criteria and agree to be contacted by Ella Association.",
    ...
    // About Page
    "aboutPage.tag": "About Ella Association",
    ...
    "aboutPage.overview.text": "Ella Association is a career-transition and digital upskilling initiative designed to support women in Geneva who aim to enter Switzerland's growing tech sector. Through hands-on practice and the development of concrete skills, participants gain the confidence and independence they need to thrive in the digital world.",
    ...
    "aboutPage.solution.text": "Ella Association provides an accessible and guided pathway for women to build digital skills and confidence through:",
  ...
  fr: {
    ...
    "partners.subtitle": "Ella Association est rendu possible grâce à des partenariats avec des organisations locales, des entreprises tech et des institutions de formation engagées pour l'inclusion et la diversité.",
    ...
    "partner.form.terms": "J'accepte d'être contacté(e) par Ella Association concernant cette demande de partenariat.",
    ...
    "apply.form.terms": "Je confirme remplir les critères d'éligibilité et j'accepte d'être contactée par Ella Association.",
    ...
    // About Page
    "aboutPage.tag": "À Propos de Ella Association",
    ...
    "aboutPage.solution.text": "Ella Association offre un parcours accessible et guidé pour que les femmes développent leurs compétences numériques et leur confiance à travers :",
