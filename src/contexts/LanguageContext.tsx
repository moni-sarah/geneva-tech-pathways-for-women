...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "about.description": "Association Ella is a career-transition and digital upskilling initiative designed to support women in Geneva who aim to enter Switzerland's growing tech sector — practicing and developing concrete skills so they can become independent in the digital world.",
    ...
    "outcomes.title": "What You Receive at Association Ella",
    ...
    "partners.subtitle": "Association Ella is made possible through partnerships with local organizations, tech companies, and training institutions committed to inclusion and diversity.",
    ...
    "partner.form.terms": "I agree to be contacted by Association Ella regarding this partnership inquiry.",
    ...
    "apply.form.terms": "I confirm that I meet the eligibility criteria and agree to be contacted by Association Ella.",
    ...
    "aboutPage.solution.text": "Association Ella provides an accessible and guided pathway for women to build digital skills and confidence through:",
  ...
  fr: {
    ...
    "partners.subtitle": "Association Ella est rendu possible grâce à des partenariats avec des organisations locales, des entreprises tech et des institutions de formation engagées pour l'inclusion et la diversité.",
    ...
    "partner.form.terms": "J'accepte d'être contacté(e) par Association Ella concernant cette demande de partenariat.",
    ...
    "apply.form.terms": "Je confirme remplir les critères d'éligibilité et j'accepte d'être contactée par Association Ella.",
    ...
    "aboutPage.overview.text": "Association Ella est une initiative d'autonomisation et de montée en compétences numériques conçue pour accompagner les femmes à Genève dans le développement des compétences digitales concrètes dont elles ont besoin — que ce soit pour accéder à un emploi dans le secteur tech, renforcer leur employabilité dans tout autre secteur, ou gagner l'indépendance nécessaire pour évoluer librement dans le monde numérique d'aujourd'hui. Grâce à une pratique concrète et un accompagnement personnalisé, les participantes développent une confiance durable, leur autonomie et la capacité de tracer leur propre chemin.",
    ...
    "aboutPage.solution.text": "Association Ella offre un parcours accessible et guidé pour que les femmes développent leurs compétences numériques et leur confiance à travers :",
