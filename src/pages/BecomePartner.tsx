...
const BecomePartner = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Become a Partner — Association Ella"
        description="Partner with Association Ella to support women transitioning into tech careers in Geneva through training, mentorship, and hiring."
        path="/become-partner"
      />
      <Navbar />
