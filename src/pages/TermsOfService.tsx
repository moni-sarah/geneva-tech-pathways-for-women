            ...
            {isFr ? (
              <div className="space-y-8 text-foreground leading-relaxed">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Les présentes conditions régissent l'utilisation de la plateforme Ellatech, qui propose un programme de transition de carrière et de montée en compétences numériques destiné aux femmes à Genève.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    L'accès au programme est ouvert aux femmes majeures résidant à Genève répondant aux critères publiés sur la plateforme. Ellatech se réserve le droit de vérifier les informations fournies.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    L'ensemble du contenu (textes, logos, graphiques, code, supports pédagogiques) est la propriété d'Ellatech ou de ses partenaires et est protégé par le droit suisse de la propriété intellectuelle. Toute reproduction sans autorisation est interdite.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Le programme Ellatech est proposé gratuitement aux participantes sélectionnées. La sélection se fait selon les critères annoncés et sur décision du comité de sélection.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Ellatech s'engage à fournir ses services avec diligence mais ne garantit pas un résultat spécifique en matière d'emploi. Dans la limite autorisée par le droit suisse, notre responsabilité est limitée aux dommages directs causés par une faute grave ou intentionnelle.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Ellatech peut modifier ces conditions à tout moment. La version en vigueur est celle publiée sur la plateforme. L'utilisation continue après modification vaut acceptation.
                  </p>
                </div>
              ...
              <div className="space-y-8 text-foreground leading-relaxed">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    These terms govern the use of the Ellatech platform, which offers a career transition and digital upskilling program for women in Geneva.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    The program is open to adult women residing in Geneva who meet the criteria published on the platform. Ellatech reserves the right to verify the information provided.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    All content (texts, logos, graphics, code, training materials) is the property of Ellatech or its partners and is protected under Swiss intellectual property law. Any reproduction without authorization is prohibited.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    The Ellatech program is offered free of charge to selected participants. Selection is based on the criteria announced and decided by the selection committee.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Ellatech provides its services with due care but does not guarantee a specific employment outcome. To the extent permitted by Swiss law, our liability is limited to direct damages caused by gross negligence or intent.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Ellatech may modify these terms at any time. The version in force is the one published on the platform. Continued use after changes constitutes acceptance.
                  </p>
                </div>
